...
if (!i18n.isInitialized) {
  i18n
    ...
    .init({
      ...
      fallbackLng: 'en',
      ns: ["common", "navbar", "login", "register", "shoplist", "profile", "shopdetails", "productdetail", "footer", "notifications", "about", "terms", "privacy", "settings", "businessinfo", "productpanel", "sales", "categories", "photos", "employees", "changes", "reservations", "myshops", "deletebusiness"],
      defaultNS: 'common',
      load: 'languageOnly',
      lowerCaseLng: true,
      cleanCode: true,
