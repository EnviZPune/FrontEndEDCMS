            ...
            >
              <div className="shop-card-image">
                ...
                <div className="shop-card-image-overlay">
                  <span className="fav-pill" title="Favorites">
                    <svg className="fav-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 21s-6.716-4.315-9.428-7.027A6.5 6.5 0 1 1 12 5.07a6.5 6.5 0 1 1 9.428 8.903C18.716 16.685 12 21 12 21z"/></svg>
