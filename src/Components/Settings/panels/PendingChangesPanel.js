...
export default function PendingChangesPanel({ business }) {
  ...
  // NEW: track per-change action loading state: { [id]: "approve" | "reject" }
                    ...
                    <div className="photo-update-grid">
                      {photos.profilePhotoUrl && (
                        <div className="photo-item">
                          <span>Profile:</span>
                          <img src={photos.profilePhotoUrl} className="photo-preview" alt="Profile preview" />
                        </div>
                      )}
                      {photos.coverPhotoUrl && (
                        <div className="photo-item">
                          <span>Cover:</span>
                          <img src={photos.coverPhotoUrl} className="photo-preview" alt="Cover preview" />
                        </div>
                      )}
                    </div>
                  )
