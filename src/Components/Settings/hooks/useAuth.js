// src/Components/Settings/hooks/useAuth.js
 ...
 * - Reads JWT from localStorage under “token” or “authToken”
 * - Parses it to extract the user’s role and ID
 * - Exposes a clearAuth() to log out
 */
